...
# Title: Top Block
# Generated: Sun Oct 29 21:01:48 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.variable_signal = variable_signal = 1
        self.variable_noise = variable_noise = 1
        ...
        # Blocks
        ##################################################
        self._variable_signal_range = Range(0, 1, 0.01, 1, 200)
        self._variable_signal_win = RangeWidget(self._variable_signal_range, self.set_variable_signal, "variable_signal", "counter_slider", float)
        self.top_layout.addWidget(self._variable_signal_win)
        self._variable_noise_range = Range(0, 1, 0.01, 1, 200)
        self._variable_noise_win = RangeWidget(self._variable_noise_range, self.set_variable_noise, "variable_noise", "counter_slider", float)
        self.top_layout.addWidget(self._variable_noise_win)
        self.tutorial_tf_tf_muler_0 = tutorial_tf.tf_muler()
        self.tutorial_tf_tf_adder_0 = tutorial_tf.tf_adder()
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 1000, variable_signal, 0)
        self.analog_fastnoise_source_x_0 = analog.fastnoise_source_c(analog.GR_GAUSSIAN, variable_noise, 0, 8192)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.tutorial_tf_tf_adder_0, 1))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.tutorial_tf_tf_muler_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.tutorial_tf_tf_adder_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.tutorial_tf_tf_muler_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_time_sink_x_3, 0))
        self.connect((self.tutorial_tf_tf_adder_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.tutorial_tf_tf_muler_0, 0), (self.blocks_throttle_1, 0))
    ...
    def get_variable_signal(self):
        return self.variable_signal

    def set_variable_signal(self, variable_signal):
        self.variable_signal = variable_signal
        self.analog_sig_source_x_0.set_amplitude(self.variable_signal)
    ...
    def set_variable_noise(self, variable_noise):
        ...
        self.analog_fastnoise_source_x_0.set_amplitude(self.variable_noise)
